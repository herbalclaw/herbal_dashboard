...
import { Trophy, Zap, Activity, TrendingUp, Flame, Crown, Timer, ArrowUpRight, ArrowDownRight } from 'lucide-react'
...
export default function ArenaBattle() {
  ...
  function updateData() {
    const data: Strategy[] = STRATEGIES.map((s) => {
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-semibold tracking-tight">Strategy Arena</h1>
                <p className="text-gray-500 text-sm">Live battle between trading strategies</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-emerald-400 text-sm font-medium bg-emerald-400/10 px-2 py-1 rounded">Top Performer</span>
              </div>
            </div>
